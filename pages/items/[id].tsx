      ...
      <div className="px-4  py-4">
        ...
        <div className="mb-8">
          ...
          <div className="flex cursor-pointer py-3 border-t border-b items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700">안니영</p>
          ...
          <div className="mt-5">
            <h1 className="text-3xl font-bold text-gray-900">사과 팝니다</h1>
            <span className="text-2xl block mt-3 text-gray-900">\3,000</span>
          ...
          <div className=" mt-6 grid grid-cols-2 gap-4">
            {[1, 1, 1, 1, 1, 1].map((_, i) => (
              <div key={i}>
                ...
                <h3 className="text-gray-700 -mb-1">배 팝니다</h3>
